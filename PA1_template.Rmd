...
The mean total number of steps taken per day was `r mean_steps`.
...
The 5-minute interval that, on average, contains the maximum number of steps was at `r max_steps_at` mins.
...
There are `r count_na_rows` missing values in the data.
